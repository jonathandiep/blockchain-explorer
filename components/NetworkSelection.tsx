  ...
  return (
    <Box marginTop={2}>
      ...
      <Link href="/?network=rinkeby">
        <a>
          <Button colorScheme="yellow" size="xs" marginRight={2} variant={network === 'rinkeby' ? 'solid' : 'outline'}>
            Rinkeby
          </Button>
        </a>
      </Link>
      ...
      <Link href="/?network=localhost">
        <a>
          <Button colorScheme="blackAlpha" size="xs" variant={network === 'localhost' ? 'solid' : 'outline'}>
            Localhost 8545
          </Button>
        </a>
      </Link>
